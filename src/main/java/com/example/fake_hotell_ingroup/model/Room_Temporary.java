...
public class Room_Temporary {
    ...
    public Room_Temporary() {};
    public Room_Temporary(int roomId, int roomTypeId, int roomOwner, String roomCode, String roomLocation, String roomDescription, String roomImgLink, double roomPrice, String roomStatus, Timestamp roomCreateDate, Timestamp roomUpdateDate) {
        this.roomId = roomId;
